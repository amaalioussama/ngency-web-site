...
export default function NavSection() {
  return <div className="flex  border-4  border-t-0 border-l-0 border-r-0">
    ...
    <div className="relative  border-4  border-t-0 border-l-0 border-b-0  h-16 w-[89px] xl:w-24">
      <Image src={logo} alt="logo" className=" absolute h-10 w-10 mt-3 ml-8 " />
    </div>
    <div className="felx justify-around bg-mediumBlue  shadow-left-lg" style={{width :"800px"}}>
    ...
    <div className="relative  border-1  border-t-0 border-r-0 border-b-0  h-16  flex justify-center items-center  w-28 xl:ml-7 ">
